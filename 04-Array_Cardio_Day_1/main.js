...
const filtered = inventors.filter( x => (x.year >= 1500 && x.year < 1600) ? true : false )
...
// const blvd = [...category.querySelectorAll('a')]
...
const ordered = people.sort((lastName, firstName) => {
